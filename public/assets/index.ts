...
export const downArrow = getImageCompletePath("/hero/down-arrow.svg");

// Hero-Lg
export const eyeLg = getImageCompletePath("/hero/lg/eye-button.png");
export const dollarLogoLg = getImageCompletePath("/hero/lg/dollar-logo.png");
export const introCubeLg = getImageCompletePath("/hero/lg/intro-cube.png");
export const introStairsLg = getImageCompletePath("/hero/lg/intro-stairs.png");
export const introPhoneLg = getImageCompletePath("/hero/lg/intro-phone.png");
export const introCubesLg = getImageCompletePath("/hero/lg/intro-cubes.png");
export const introPillarLg = getImageCompletePath("/hero/lg/intro-pillar.png");
...
// Boost
export const boostBurger = getImageCompletePath("/boost/boost-burger.png");
export const boostCard = getImageCompletePath("/boost/boost-card.png");
export const boostCoffee = getImageCompletePath("/boost/boost-coffee.png");
export const boostHand = getImageCompletePath("/boost/boost-hand.png");
export const boostPhone = getImageCompletePath("/boost/boost-phone.png");
export const boostShoe = getImageCompletePath("/boost/boost-shoe.png");
export const boostStairs1 = getImageCompletePath("/boost/boost-stairs-1.png");
export const boostStairs2 = getImageCompletePath("/boost/boost-stairs-2.png");
